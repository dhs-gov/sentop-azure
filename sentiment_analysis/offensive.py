...
class Sentiment:
    def __init__(self, sentiment, notoffensive, offensive):
        self.sentiment = sentiment
        self.notoffensive = float(truncate(notoffensive, 3))
        self.offensive = float(truncate(offensive, 3))
...
def assess(classifier, docs):
    ...
    sentlog.append("----------------------------------------------------------")
    sentlog.append("Assessing offensive sentiment. Please wait...")
    sentiments = []
    i = 0
    for doc in docs:
        #print("doc: ", doc)
